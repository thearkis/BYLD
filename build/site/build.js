            ...
            Ajax({
                ...
                success: function (data) {
                    ...
                    self.empty().append(
                        ...
                        Beast.node("Intro",{__context:this,"Type":"Brand"},"\n                            ",randomizedItems.map(function(item, index) {
                                ...
                                if (mediaItem) {
                                    if (mediaItem._type === 'image') {
                                        return Beast.node("image",undefined,mediaItem.asset.url)
                                    } else if (mediaItem._type === 'file') {
                                        return Beast.node("video",undefined,mediaItem.asset.url)
                                    }
                                }
                            }),"\n                            \n                            ",randomizedItems.map(function(item, index) {
                                return (
                                    Beast.node("title",undefined,item.project.projectName," / ",item.client.name)
                                )
                            }),"\n                        ")
                ...
                error: function (xhr, status, error) {
                    ...
                    self.empty().append(
                        Beast.node("item",{__context:this},"\n                            ",Beast.node("title",undefined,"Error loading featured content"),"\n                        ")
                    )
                }
            })
        },
...
Beast.decl({
    ...
    Gallery__item: {
        expand: function () {
            this.append(
                Beast.node("Thumb",{__context:this},this.text())
            )
        },
...
Beast.decl({
    ...
    Form__action: {
        expand: function () {
            ...
            this.append(
                Beast.node("Button",{__context:this,"icon":"arrow","Size":"XL","Type":"Action"},this.text())
            )    
        }
    },
})
...
Beast.decl({
    Input: {
        ...
        expand: function fn () {
            ...
            var input = Beast.node("input",{__context:this})

            this.append(
                Beast.node("label",{__context:this},this.param('title')),
                input,
                Beast.node("clear",{__context:this})
            )
...
Beast.decl({
    Intro: {
        ...
        expand: function () {
            this.append(
                ...
                Beast.node("content",{__context:this},this.get('logo', 'title', 'subtitle')),
                this.get('headline'),
                Beast.node("footer",{__context:this},Beast.node("Button",{"hint":"00:00","icon":"Play"},"Watch "))
            )
        },
        domInit: function fn() {
    ...
    Intro__logo: {
        ...
        expand: function () {
            this.append(
                Beast.node("Logo",{__context:this})
            )
        }
    },
                    ...
                    self.empty().append(
                        ...
                        json.result.map(function(item, index) {
                            ...
                            return (
                                ...
                                Beast.node("Roles",{__context:this,"Work":true},"\n                                    \n                                        ",jobs.map(function(item, index) {
                                            ...
                                            return (
                                                Beast.node("Link",{"href":link},"\n                                                    \n                                                        ",Beast.node("item",undefined,item.title),"\n                                                        ",Beast.node("item",{"Gray":true},item.employmenttype),"\n                                                        ",Beast.node("item",{"Gray":true},item.location),"\n                                                   \n                                                ")
                                            )                                            
                    ...
                    self.empty().append(
                        ...
                        json.result.map(function(item, index) {
                            ...
                            return (
                                ...
                                Beast.node("item",{__context:this},"\n                                    \n                                    ",Beast.node("title",undefined,job.title),"\n                                    ",Beast.node("location",undefined,job.location),"\n                                    ",Beast.node("type",undefined,job.employmenttype),"\n                                    ",Beast.node("text",undefined,"\n                                        ",job.text.map(function(item, index) {
                                            

                                            if (item !== undefined) {

                                                if (item.style !== 'normal') {
                                                    return Beast.node("p",{"Type":item.style},item.text)
                                                }
                                                if (item.list === 'bullet') {
                                                    return Beast.node("p",{"Type":"list"},item.text)
                                                }
                                                return Beast.node("p",{"Type":item.mark[0][0]},item.text)
                                            }
                                        }),"\n                                    "),"\n                                "),

                                Beast.node("item",{__context:this},"\n                                    ",Beast.node("title",undefined,"Interested in this role?"),"\n                                    ",Beast.node("level",undefined,"\n                                        ",Beast.node("Nav",undefined,"\n                                            ",Beast.node("item",undefined,"\n                                                ",Beast.node("Link",{"href":"mailto:work@zenno.space"},"\n                                                    ",Beast.node("Button",{"Type":"action","icon":"Arrow","Size":"XL"},"Apply now"),"\n                                                "),"\n                                            "),"\n                                            \n                                        "),"\n                                    "),"\n                                ")
                            )
...
Beast.decl({
    Live: {
        expand: function () {
            this.append(
                Beast.node("circle",{__context:this}),
                Beast.node("text",{__context:this},this.text())
            )
        }   
    }
    ...
    Zones: {
        ...
        expand: function () {
            ...
            this.append(
                ...
                Beast.node("item",{__context:this},"\n                    ",Beast.node("time",{"Iceland":true},"16:36"),"\n                    ",Beast.node("name",undefined,"Reykjavík"),"\n                "),

                Beast.node("item",{__context:this},"\n                    ",Beast.node("time",{"Amsterdam":true},"19:36"),"\n                    ",Beast.node("name",undefined,"Amsterdam"),"\n                "),

                Beast.node("item",{__context:this,"":true},"\n                    ",Beast.node("time",{"Moscow":true},"19:36"),"\n                    ",Beast.node("name",undefined,"Moscow"),"\n                "),
        ...
        requestApiV2: function (path, data) {
            ...
            Ajax({
                ...
                success: function (data) {
                    ...
                    if (json.isPlaying) {
                        self.empty().append(
                            Beast.node("text",{__context:this,"Minor":true},"mood"),
                            Beast.node("Live",{__context:this},Beast.node("circle")," ",json.artist," — ",json.title),
                            Beast.node("Thumb",{__context:this},json.albumArt)
                        );
                    } else {
                        // No track is playing, render "Burial — Wounder"
                        self.empty().append(
                            Beast.node("text",{__context:this,"Minor":true},"mood"),
                            Beast.node("Live",{__context:this},Beast.node("circle")," Burial — Wounder")
                        );
                    }
                },
                error: function () {
...
Beast.decl({
    ...
    Menu__item: {
        expand: function () {
            this.append(
                Beast.node("Link",{__context:this,"href":this.param('href')},"\n                    ",Beast.node("Button",{"Type":"Blur"},this.text()),"\n                ")
            )
        }
    },
...
Beast.decl({
    Textarea: {
        ...
        expand: function fn () {
            ...
            var textarea = Beast.node("textarea",{__context:this})
...
Beast.decl({
    ...
    WorkCard__link: {
        expand: function () {
            this.append(
                Beast.node("Link",{__context:this,"New":true,"href":this.param('href')},this.text())
            )
        }
    },
    ...
    Work__item: {
        expand: function () {
            ...
            this.append(
                Beast.node("Thumb",{__context:this,"Ratio":this.param('ratio'),"col":"max"},this.text())
            )
        }
    },
...
Beast.decl({
    ...
    Screen__container: {
        expand: function () {
            ...
            this.append(
                Beast.node("wrap",{__context:this},"\n                    ",Beast.node("Thumb",{"Ratio":this.param('ratio'),"col":"max"},this.param('src')),"\n                    ",this.get('image'),"\n                ")
            )
        }
    },
